                ...
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{$ticket->user_id}}</div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                @if($ticket->status === 'Open')
                                    <a href="{{ url('tickets/' . $ticket->ticket_id) }}" class="text-indigo-600 hover:text-indigo-900">Comment</a>
                                    <form action="{{ url('admin/close_ticket/' . $ticket->ticket_id) }}" method="POST">
                                        {!! csrf_field() !!}
                                        <button type="submit" class="text-indigo-600 hover:text-indigo-900">Close</button>
                                    </form>
                                @endif
                            </td>
                        </tr>
